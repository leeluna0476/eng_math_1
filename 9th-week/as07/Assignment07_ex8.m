...
% 1,1,1 (흰색)부터 1,0,0(빨간색)까지 그라데이션.
linc2 = [linspace(1,1,size(orbit,1)); linspace(1,0,size(orbit,1)); linspace(1,0,size(orbit,1));]';
...
for x1 = 0:0.3:20
    ...
    orbit2(end,:) = [y(1,5) y(2,5) y(3,5)];


    % 꼭지점에 가까운 데이터일수록 진한 색으로 표시.
